...
#          Systems
# Date: July 2023
# Description: Install and build Ethereum Proof of Stake on the remote hosts
#===============================================================================
...
cmd='./eth-pos/remote/install-eth-pos.sh'
utils::exec_cmd_on_remote_hosts "${cmd}" 'Install and build Ethereum Proof of '\
'Stake on remote hosts' "${remote_hosts_list[@]}"
