...
#          Systems
# Date: July 2023
# Description: Start/stop/kill Ethereum PoS on remote hosts
#===============================================================================
...
cmd="./eth-pos/remote/eth-pos.sh ${action}"
utils::exec_cmd_on_remote_hosts "${cmd}" "${action} Ethereum PoS on remote "\
